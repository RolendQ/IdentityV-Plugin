...
public class Chest {
    ...
    public Chest(IdentityV plugin, Location loc) {
        this.plugin = plugin;
        this.loc = loc;
    ...
    public ItemStack generateItem(int n) {
        if (n < Config.getInt("attributes.chest","flaregun_chance")) return new ItemStack(Material.FIREWORK,1);
        if (n < Config.getInt("attributes.chest","controller_chance")) return new ItemStack(Material.IRON_PICKAXE,1);
        if (n < Config.getInt("attributes.chest","football_chance")) return new ItemStack(Material.LEATHER_HELMET,1);
        if (n < Config.getInt("attributes.chest","elbowpad_chance")) return new ItemStack(Material.IRON_CHESTPLATE,2);
        if (n < Config.getInt("attributes.chest","perfume_chance")) return new ItemStack(Material.GOLD_CHESTPLATE,2);
        if (n < Config.getInt("attributes.chest","wand_chance")) return new ItemStack(Material.BLAZE_ROD,1);
        if (n < Config.getInt("attributes.chest","syringe_chance")) return new ItemStack(Material.SHEARS,1);
