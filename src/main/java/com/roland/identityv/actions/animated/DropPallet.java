...
public class DropPallet {
     ...
     * @param block
     */
    public DropPallet(final Survivor survivor, final Block block, final BlockFace otherFace) {
        // TODO might make the survivor freeze and add animation
        FreezeActionManager.getInstance().add(survivor.getPlayer(), Config.getInt("timers.survivor","pallet_delay") + 3);
        ...
        }.runTaskLater(IdentityV.plugin,Config.getInt("timers.survivor","pallet_delay"));
    }
}
