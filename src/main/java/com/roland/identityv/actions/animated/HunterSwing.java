...
public class HunterSwing {
     ...
     * @param hunter
     */
    public HunterSwing(final Hunter hunter) {
        ...
        hunterP.getWorld().playSound(hunterP.getLocation(), Sound.WITHER_SHOOT, 3, 0.6F);
        ...
        }.runTaskLater(IdentityV.plugin, Config.getInt("timers.hunter","swing_delay"));
    }
